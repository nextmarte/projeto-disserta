...
A literatura sobre fundos de investimento imobiliário têm crescido na última década no Brasil, mas nem sempre os FIIs foram populares do ponto de vista acadêmico, isso fica bem evidente ao se analisar o trabalho de Weise et al. [@weise2017] que fez um estudo bibliométrico em 2017 sobre as publicações sobre Fundos de Investimento Imobiliário e Real State Trusts (REITS) na base indexada Web of Science.
...
De acordo com Alencar & Cosentino [@alencar2011] o sistema brasileiro de Fundos de Investimento Imobiliário ainda era na primeira década dos anos 2000 muito menor em termos de valor de mercado em comparação com os sistemas dos Estados Unidos, França e Reino Unido, porém, em suas conclusões projetaram o crescimento do mercado nacional que já estava mostrando os primeiro passos do crescimento apresentado na década de 2010. Além disso, aos autores encontraram aderência entre o desemepenho dos FIIs brasileiros com o mercado financeiro nacional, mostrando que essa característica que foi explorada também por Scolese [@scolese2015] em 2015 também era observado nos anos 2000.

A partir dessa breve revisão e dos apontamentos de Weise et al. [@weise2017] em seu estudo bibliométrico foi possível verificar que parte da bibliografia atual sobre FIIs está concentrada em criar e testar estratégias de investimento, oque abre espaço para pesquisas voltadas a entender o comportamento do consumidor deste tipo de ativo e do crescimento do mercado.

### Séries temporais 

Visto que a maior parte das variáveis consideradas neste trabalho são expressas em séries temporais, cabe ressaltar algumas das características que serão usadas no contexto deste trabalho, como a volatilidade, a estacionariedade e estocasticidade. As séries temporais são conjuntos de observações coletadas sequencialmente ao longo do tempo. Elas são caracterizadas pela dependência temporal, ou seja, a observação em um determinado momento depende das observações anteriores.

A estacionariedade é uma propriedade das séries temporais que se refere à estabilidade das suas características estatísticas ao longo do tempo. Uma série temporal é considerada escionária quando suas propriedades estatísticas, como média, variância e autocorrelação, permanecem constantes ao longo do tempo. Isso implica que as tendências, sazonalidades e padrões presentes na série não mudam significativamente ao longo do tempo [@tsay2002].
...
O trabalho se utilizará do método PRISMA (*Preferred Reporting Items for Systematic Reviews and Meta-Analyses*) [@page2021] para elaboração da revisão sistemática da literatura usando a ferramenta Parsifal [@parsifal2023] . Este protocolo é amplamente usado para elaboração de revisões sistemáticas e tem por característica a comunicação do processo, o que garante transparência para o trabalho.

O PRISMA possui uma série de passos [@page2021] [@parsifal2023] para aplicação do método:
...
6.  Relatório final: Seguindo o *checklist*, será apresentado um relato sobre os resultados da revisão.

A condução levará em conta artigos publicados sobre fundos de investimento imobiliário e sobre comportamento do investidor deste tipo de ativo e será realizada na mesma janela de tempo deste trabalho, de 2013 até 2023.

A pesquisa será feita nas bases indexadas Web of Sciece, Scielo e Periódicos Capes além dos sites Research Rabbit e Scite AI.
